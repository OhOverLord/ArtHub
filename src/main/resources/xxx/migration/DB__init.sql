...
create table public.image (id bigserial not null, data bytea, primary key (id));
...
create table public.tag (id bigserial not null, user_id bigint, name varchar(30) unique, primary key (id));
...
alter table if exists public.tag add constraint FKluryeqc4byhtnr4xhr47hjchw foreign key (user_id) references public.patron;
